...
local ACI_Alpha_Normal = 0							-- 비전투중 안보이게 하려면 0
...
ACI_SpellList_MAGE_2 = {
	...
	{3, {116267, 7, "player", nil, 4}, 1, {"마력의 룬", 11, nil, true}},
	{"발화", 2},
	{7, {"얼음 방패", 1}, {269651, 7, "player", 4, 2}, 1},
};
...
local function ACI_OnUpdate(self, elapsed)
...
function ACI_Init()
	...
	ACI_mainframe:SetScript("OnUpdate", nil);
	...
	if (ACI_SpellList and #ACI_SpellList) then
		...
		ACI_mainframe:SetScript("OnUpdate",ACI_OnUpdate);
