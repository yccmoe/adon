...
local APB_ALPHA_NORMAL = 0
local APB_SHOW_HEALTHBAR = true -- 생명력바 표시
...
local function APB_CheckPower(self)
	...
	if (englishClass == "PALADIN") then
		...
		if (spec and spec == 3) then
			...
			local _, _, _, selected, _ = GetTalentInfo(7, 3, talentgroup);
	...
	if (englishClass == "MAGE") then
		...
		if (spec and spec == 2) then
			...
			local _, _, _, selected, _ = GetTalentInfo(4, 3, talentgroup);
		...
		if (spec and spec == 3) then
			...
			local _, _, _, selected, _ = GetTalentInfo(4, 2, talentgroup);
	...
	if (englishClass == "HUNTER") then
		...
		--	bupdate_spell = true;
			...
			local _, _, _, selected, _ = GetTalentInfo(6, 2, talentgroup);
	...
	if (englishClass == "SHAMAN") then
		...
		if (spec and spec == 1) then
			...
			local _, _, _, selected, _ = GetTalentInfo(6, 3, talentgroup);
...
APB.bar.text = APB.bar:CreateFontString(nil, "BORDER")
...
APB.bar.count = APB.bar:CreateFontString(nil, "BORDER")
...
APB.bar.myManaCostPredictionBar = APB.bar:CreateTexture(APB.bar, "BORDER" ,"MyManaCostPredictionBarTemplate") 
...
APB.healthbar.myManaCostPredictionBar = APB.bar:CreateTexture(APB.healthbar, "OVERLAY" ,"MyManaCostPredictionBarTemplate") 
--APB.myManaCostPredictionBar:SetVertexColor(0.055, 0.875, 0.825)
...
APB.healthbar.text = APB.healthbar:CreateFontString(nil, "BORDER")
...
APB.healthbar.count = APB.bar:CreateFontString(nil, "BORDER")
...
APB.buffbar.text = APB.buffbar:CreateFontString(nil, "BORDER")
...
APB.buffbar.count = APB.buffbar:CreateFontString(nil, "BORDER")
...
APB.buffbar.cast = APB.buffbar:CreateTexture(nil, "ARTWORK");
...
APB.buffbar.square = {};
for i = 1, 10 do
	APB.buffbar.square[i] = APB.buffbar:CreateTexture(nil, "ARTWORK");
...
APB.buffbar.square2 = APB.buffbar:CreateTexture(nil, "ARTWORK");
...
APB.buffbar.square3 = APB.buffbar:CreateTexture(nil, "ARTWORK");
...
APB.buffbar.square4 = APB.buffbar:CreateTexture(nil, "ARTWORK");
