...
ANS_SpellList_MAGE_2 = {
	...
	{"불덩이 작렬", 1, false, {9,1,3}, {6, 30, "target", true}, {2, "열기","player", 0.1, false, false}, {16, "불태우기"}},
	{"불덩이 작렬", 1, false, {2, "발화", "player", 0.1, false, false}, {2, "열기","player", 0.1, false, false}, {16, "불태우기"}},
	{"불덩이 작렬", 2, true, {2, "화염 파열", "player", 0.1, false, false}},
	{"불사조의 불길", 1, false, {2, "열기","player", 0.1, true, false}, {2, "발화", "player", 0.1, false, false}},
	{"불사조의 불길", 1, false, {7,3}, {2, "열기","player", 0.1, true, false}},
	{"화염 작렬", 1, false,{9,1,3}, {6, 30, "target", true} ,{2, "열기","player", 0.1, true, false}, {16, "불태우기"}},
	{"불태우기", 1, false, {9,1,3}, {6, 30, "target", true}},
...
function ANS_OnUpdate(self, elapsed)
...
function ANS_Init()
	...
	ANS_mainframe:SetScript("OnUpdate",nil);
	...
	--	ChatFrame1:AddMessage("[ANS] ".. listname .. "을 Load 합니다.");
		...
		ANS_mainframe:SetScript("OnUpdate",ANS_OnUpdate);
